 ...
 * expand 阶段并行新表 t_media_metadata_v2，contract 阶段（issue #21）rename 为 t_media_metadata。
 */
@Data
@EqualsAndHashCode(callSuper = true)
@TableName("t_media_metadata_v2")
public class MediaMetadataV2 extends BaseEntity {

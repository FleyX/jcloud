  ...
  <div class="flex h-full flex-col gap-5">
    ...
    <div class="flex flex-col gap-4 rounded-2xl border border-surface-200 bg-white p-5 shadow-card sm:flex-row sm:items-center sm:justify-between">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h2 class="text-lg font-bold text-surface-900">用户管理</h2>
          <p class="text-xs text-surface-500">管理系统用户及其角色权限</p>
        </div>
      </div>
      ...
      <div class="overflow-x-auto">
        <table class="w-full text-left text-sm">
          ...
          <tbody class="divide-y divide-surface-100">
            <tr v-for="user in pageData.records" :key="user.id" class="hover:bg-surface-50/50">
              <td class="px-5 py-3">
                <input
                  type="checkbox"
              ...
              <td class="px-5 py-3 text-surface-600">{{ user.nickname || '-' }}</td>
              ...
              <td class="px-5 py-3">
                <div class="flex flex-wrap gap-1">
                  ...
                  <span v-if="user.roles.length === 0" class="text-xs text-surface-400">未分配</span>
                </div>
              </td>
              <td class="px-5 py-3">
                <SwitchRoot

...
<template>
  ...
  >
    ...
    <nav class="flex-1 px-3 py-5">
      <ul class="space-y-1">
        <li v-for="item in menuStore.secondaryMenus" :key="item.key">
          <button
            :class="
              cn(
    ...
    <!-- 底部容量微件 -->
    <div v-if="showCapacityWidget" class="border-t border-surface-200 p-4">
      <!-- 容量卡片 -->
      <div
      ...
      >
        <div class="mb-3 flex items-center gap-2">
          ...
          <div>
            <p class="text-xs font-medium text-surface-500">个人空间</p>
